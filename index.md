...
My research interest focus on **High-DOF Robotics Manipulation**, **Learning-based Control** and **VLM in Robotics**. Currently, I'm focusing on designing learning-based control algorithms for multi-arm robotics systems with high DoF for dexterous manipulation missions. Besides, I'm still working on VLM-based robot manipulation.  

## Recent News

- 01-31-2026: Our paper "Information-theoretic graph fusion with VLA model for policy reasoning and dual robotic control" is officially online! See the details on the [**link**](https://doi.org/10.1016/j.inffus.2026.104193). :point_left:
...
<div style="display: flex; align-items: center; margin-top: 20px; margin-bottom: 20px;">
  ...
  <div style="text-align: left; flex-grow: 1;"> <span style="color:#1772d0; display: block; margin-bottom: 10px; font-size: 1.25rem;">
    ...
    <p style="color:rgb(251, 252, 255); margin-top: 0; margin-bottom: 0;">
    <span style="display: inline-block; margin-right: 10px;">
    </span>
    <ul style="list-style-type: disc; padding-left: 20px; margin-top: 5px; margin-bottom: 10px;">
