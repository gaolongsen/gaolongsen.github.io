...
# What's the SVM?
SVM is the abbrevision of (support Vector Machines), as a kind of classification method which has been used in many fields. Here we can use an example to show how to understand the princple of SVM. 

On Valentine's Day long ago, a warrior was going to save his lover, but the devil in the sky played a game with him.
